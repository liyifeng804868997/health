...
public class MessageConstant {
    ...
    public static final String DELETE_SETMEAL_FAIL = "删除套餐成功";
    ...
    public static final String NAME_ORDERED = "单个手机只能绑定一位用户，用户姓名错误";
    public static final String IDCARD_ORDERED = "单个手机只能绑定一位用户，用户身份证不匹配";
